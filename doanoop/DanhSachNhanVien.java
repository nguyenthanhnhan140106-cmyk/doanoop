                ...
                switch (chon) {
                    ...
                    case 2:
                        ...
                        while (true){
                            ...
                            boolean emailExists = false;
                            for (nhanVien X : a) {
                                if (X.getemail().equalsIgnoreCase(email) && !X.getid().equals(nv.getid())) {
                                    emailExists = true;
                                    break;
                                }
                            }
                    ...
                    case 3:
                        ...
                        while (true){
                            ...
                            boolean sdtExists = false;
                            for (nhanVien X : a) {
                                if (X.getsdt().equals(sdt) && !X.getid().equals(nv.getid())) {
                                    sdtExists = true;
                                    break;
                                }
                            }
        ...
        public void xoaNhanVien() {
            ...
            do {
                ...
                if (chon >= 1 && chon <= 4) {
                    ...
                    System.out.print("\nNhập số thứ tự nhân viên cần xóa (VD: 1,4.. - 0 để hủy): ");
                    String luaChonXoaStr;
                    try {
                        luaChonXoaStr = sc.nextLine().trim();
                    } catch (Exception e) {
                        System.out.println("Lựa chọn không hợp lệ!");
                        sc.nextLine();
                        continue;
                    ...
                    if (luaChonXoaStr.equals("0")) {
                        System.out.println("Đã hủy xóa.");
                        continue;
                    }

                        String[] chuoiSoThuTu = luaChonXoaStr.split(",");
                        ArrayList<Integer> danhSachSoThuTu = new ArrayList<>();
                        boolean hopLe = true;

                        for (String soStr : chuoiSoThuTu) {
                            try {
                                int so = Integer.parseInt(soStr.trim());
                                if (so < 1 || so > ketQuaTimKiem.size()) {
                                    System.out.println("Số thứ tự " + so + " không hợp lệ!");
                                    hopLe = false;
                                    break;
                                }
                                danhSachSoThuTu.add(so);
                        ...
                        // Hiển thị danh sách nhân viên sắp xóa
                        System.out.println("\n=== DANH SÁCH NHÂN VIÊN SẮP XÓA ===");
                        ArrayList<nhanVien> danhSachXoa = new ArrayList<>();
                        for (int soThuTu : danhSachSoThuTu) {
                            nhanVien nv = ketQuaTimKiem.get(soThuTu - 1);
                            danhSachXoa.add(nv);
                            System.out.println(soThuTu + ". " + nv);
                        }

                        String confirm = "";
                        while (true) {
                            System.out.print("\nBạn có chắc muốn xóa " + danhSachXoa.size() + " nhân viên này không? (y/n): ");
                        ...
                        if (confirm.equals("y")) {
                            ...
                            for (nhanVien nv : danhSachXoa) {
                                a.remove(nv);
                            }
                            System.out.println("Đã xóa " + danhSachXoa.size() + " nhân viên khỏi danh sách!");
                            return;
                        } else {
